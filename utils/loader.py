...
class TorchDataset(Dataset):
    ...
    def __init__(self, text, slot, intent, rawtext):
        self.__text = text
        self.__slot = slot
    ...
    def __getitem__(self, index):
        return self.__text[index], self.__slot[index], self.__intent[index], self.__rawtext[index]
...
class DatasetManager(object):
    ...
    def num_training_samples(self):
        return len(self.__text_slot_data['train'])
    ...
    def batch_delivery(self, data_name, batch_size=None, is_digital=True, shuffle=True):
        ...
        rawtext = self.__text_word_data[data_name]
        ...
        dataset = TorchDataset(text, slot, intent, rawtext)
